...
public abstract class ServiceLoaderKspPlugin  : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        val kspPluginDep = target.dependencies.create("io.github.hfhbd.serviceloader:ksp-plugin:$VERSION")
        val runtimeDep = target.dependencies.create("io.github.hfhbd.serviceloader:runtime:$VERSION")
