...
public abstract class ServiceLoaderPlugin : KotlinCompilerPluginSupportPlugin {
    override fun apply(target: Project) {
        ...
        kotlin.sourceSets.configureEach {
            it.dependencies {
                implementation("io.github.hfhbd.serviceloader:runtime:$VERSION")
            }
        }
    }
    ...
    override fun getCompilerPluginId(): String = "io.github.hfhbd.serviceloader"

    override fun getPluginArtifact(): SubpluginArtifact = SubpluginArtifact(
        groupId = "io.github.hfhbd.serviceloader",
